...
From https://github.com/microsoft/MeshGraphormer/blob/main/src/modeling/bert/modeling_graphormer.py,
...
class GraphormerLayer(nn.Module):
    def __init__(self, config):
        ...
        if self.has_graph_conv == True:
            self.graph_conv = GraphResBlock(config.hidden_size, config.hidden_size)
